...
impl OrbitDef {
    ...
    fn possible_orders<const N: usize>(
        ...
        {
            assert!(self.piece_count.get() < FIRST_65_PRIMES[N]);
            assert!(u16::from(orientation_count.get()) < FIRST_65_PRIMES[N]);
        }

        let invalid_prime_index = FIRST_65_PRIMES.partition_point(|&prime| prime <= piece_count);
        ...
        while let Some((prime_index, remaining_pieces_count, acc_order)) = stack.pop() {
            ...
            *prime_power_exps.prime_exponent_mut(prime_index) = 1;
...
impl<const N: usize> PuzzleDef<N> {
    ...
    fn connected_component_possible_orders(&self, connected_component: &[u16]) -> LcmOrders<N> {
        ...
        match *connected_component {
            ...
            [singular_component] => {
                ...
                return LcmOrders::OrbitOrders(match orbit_def.parity_constraint {
                    ...
                    ParityConstraint::None | ParityConstraint::Dependent => {
                        orbit_def.combined_parity_possible_orders()
                    }
                });
            }
            _ => (),
        ...
        let mut work = connected_component
            ...
            .flat_map(|(symbol, &orbit_index)| {
                let (even_parity_orders, Some(odd_parity_orders)) =
                    self.orbit_defs()[usize::from(orbit_index)].uncombined_parity_possible_orders()
                else {
...
mod orbit {
    ...
    fn test_possible_orders(orbit_def: OrbitDef, expected: Expected) {
        match orbit_def.piece_count.get() {
            ...
            P9..P17 => {
                test_possible_orders_n::<16>(orbit_def, expected);
            }
            P17..P33 => {
                test_possible_orders_n::<32>(orbit_def, expected);
            }
            P33..P65 => {
                test_possible_orders_n::<64>(orbit_def, expected);
            }
    ...
    fn landau() {
        for (piece_count, landau) in [
            ...
            13_860, 16_380, 16_380, 27_720, 30_030, 32_760, 60_060, 60_060, 60_060, 60_060,
            120_120, 120_120, 180_180, 180_180, 180_180, 180_180, 360_360, 360_360, 360_360,
            360_360, 471_240, 510_510, 556_920, 1_021_020,
        ]
        .into_iter()
        .enumerate()
        .skip(1)
    ...
    fn same_piece_count_and_orientation_count_zero_orientation_sum_constraint() {
        for (same_count, mut expected) in [
            (
                ...
                Expected {
                    highest: 642_507_465_600,
                    combined_len: 155_425,
                    uncombined_lens: (149_639, Some(129_050)),
                },
            ),
            (
                PRIME_PIECE_COUNT,
                Expected {
                    highest: 302_513_931_720,
                    combined_len: 68050,
...
mod puzzle {
    ...
    fn cube4() {
        test_possible_orders(
            ...
            877,
            [
                360_360, 376_740, 406_980, 437_580, 471_240, 489_060, 510_510, 556_920, 720_720,
                765_765,
            ],
        );
    }
    ...
    fn minx3() {
        test_possible_orders(
            ...
            1278,
            [
                278_460, 282_744, 308_880, 332_640, 353_430, 360_360, 432_432, 471_240, 540_540,
                720_720,
            ],
        );
    }
    ...
    fn minx5() {
        test_possible_orders(
            ...
            [
                ...
                952_435_607_563_440,
                986_757_611_439_600,
                1_068_586_291_412_640,
                1_184_109_133_727_520,
                1_241_870_554_884_960,
                1_335_732_864_265_800,
                1_357_393_397_199_840,
                1_413_291_546_707_040,
            ],
        );
    }
