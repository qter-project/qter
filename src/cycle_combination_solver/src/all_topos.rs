...
impl Iterator for AllTopologicalSorts {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        loop {
            ...
            // Remove edges from q
            for &successor in &self.successors[q] {
                // successor counts were u32; we assume graph is a DAG so won't underflow
                self.count[successor] -= 1;
...
mod tests {
    ...
    fn simple_graph() {
        ...
        assert_eq!(results, vec![vec![0, 1, 2, 3], vec![0, 1, 3, 2]]);
    }
    ...
    fn linear_graph() {
        ...
        assert_eq!(results, vec![vec![0, 1, 2, 3]]);
    }
    ...
    fn diamond_graph() {
        ...
        assert_eq!(results, vec![vec![0, 1, 2, 3], vec![0, 2, 1, 3]]);
    }
